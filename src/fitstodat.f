      ...
      integer       nlh
      integer       nw,nt,nl
      character*(80) header(200)
      character(280)  filein,fileout
      integer        unitout,blocksize
      real*8         lambdaz,dlambda
      integer        i,istat,Lfits
...
!      fileout='test.dat'
      ...
      open(unitout,file=fileout,status='replace')
...
*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      character*(80) header(200)
      character(280)  comment
      integer       nlh,nlhtot
      integer       istat,Lfits
      integer       blocksize,nfound,naxes(2)
      integer       istart,iend,i
      character*(280) inclist(1),exclist(1)
      integer        rien,hdutype
...
c      call FTGREC(Lfits,0,comment,istat)
...
*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      character(80) comm
      integer       unitout,nfound
      double precision dlambda
      double precision lambdaz
      integer       blocksize,nlambda,hdutype
      logical       anyf
      real*8        lambdaLCB(nmaxlambdaLCB)
...
*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      character(80) comm
      integer       unitout,nfound
      real*8        lambda(nmaxlines)
      integer       blocksize,nlambda,ncols
      logical       anyf
...
*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      integer        nt
      integer        istat,unitout,Lfits,i,it,npara,blocksize
      character(80)  comm
      real*8         params(nmaxparams),column(nmaxotimes)
      logical        anyf
...
*%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      integer        nt,hdutype
      integer        istat,unitout,it,nl,blocksize,Lfits,i
      character(80)  comm
      logical        anyf
      real           Lsol
